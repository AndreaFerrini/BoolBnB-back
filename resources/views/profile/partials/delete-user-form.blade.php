<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Una volta che il tuo account sarà eliminato, tutte le risorse e i dati saranno persi permanentemente. Prima di procedere ad eliminare il tuo account, assicurati di scaricare o di salvare i dati che ritieni importanti.') }}
        </p>
    </header>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 class="text-lg font-medium text-gray-900">
                        {{ __('Sei sicuro di voler procedere ad eliminare il tuo account?') }}
                    </h2>
                    <p class="mt-1 text-sm text-gray-600">
                        {{ __('Una volta che il tuo account sarà eliminato, tutte le risorse e i dati saranno persi permanentemente. Prima di procedere ad eliminare il tuo account, assicurati di scaricare o di salvare i dati che ritieni importanti.') }}
                    </p>
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('admin.profile.destroy') }}" class="p-6">
                        ...
                        <div class="input-group">
                            ...
                            <input id="password" name="password" type="password" class="form-control" placeholder="{{ __(' Inserisci la tua password') }}" />
