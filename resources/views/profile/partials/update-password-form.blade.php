<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">{{ __('Aggiorna password') }}</h2>

        <p class="mt-1 text-sm text-gray-600">{{ __('Assicurati che il tuo account utilizzi una password lunga e casuale per rimanere al sicuro.') }}</p>
    </header>
